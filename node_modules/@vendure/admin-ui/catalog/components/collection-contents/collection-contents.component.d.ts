...
export declare class CollectionContentsComponent implements OnInit, OnChanges, OnDestroy {
    ...
    refresh(): void;
    private setParam;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<CollectionContentsComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<CollectionContentsComponent, "vdr-collection-contents", never, { "collectionId": "collectionId"; }, {}, ["headerTemplate"], never>;
}

//# sourceMappingURL=collection-contents.component.d.ts.map