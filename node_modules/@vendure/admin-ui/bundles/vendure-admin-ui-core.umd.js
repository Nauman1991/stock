(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function transformRelationCustomFieldInputs(variables, customFieldConfig) {
        ...
        if (variables.input) {
            if (Array.isArray(variables.input)) {
                try {
                    for (var _b = __values(variables.input), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var item = _c.value;
    ...
    var AppComponent = /** @class */ (function () {
        function AppComponent(dataService, serverConfigService, localStorageService, document) {
        ...
        AppComponent.prototype.ngOnInit = function () {
            ...
            this.dataService.client
                ...
                .pipe(operators.filter(function (loggedIn) { return loggedIn === true; }), operators.switchMap(function () {
                return _this.dataService.client.uiState().mapStream(function (data) { return data.uiState.contentLanguage; });
            }), operators.switchMap(function (contentLang) {
                return _this.serverConfigService
                    .getAvailableLanguages()
                    .pipe(operators.map(function (available) { return [contentLang, available]; }));
            }))
                .subscribe({
                next: function (_b) {
                    var _c = __read(_b, 2), contentLanguage = _c[0], availableLanguages = _c[1];
                    _this.localStorageService.set('contentLanguageCode', contentLanguage);
                    if (availableLanguages.length && !availableLanguages.includes(contentLanguage)) {
                        _this.dataService.client.setContentLanguage(availableLanguages[0]).subscribe();
                    }
                },
            });
        };
    ...
    var DefaultInterceptor = /** @class */ (function () {
        ...
        DefaultInterceptor.prototype.intercept = function (req, next) {
            ...
            return this.dataService.client.uiState().single$.pipe(operators.switchMap(function (_d) {
                var uiState = _d.uiState;
                var _a;
    ...
    var CurrencyInputComponent = /** @class */ (function () {
        ...
        CurrencyInputComponent.prototype.ngOnInit = function () {
            ...
            var shouldPrefix$ = rxjs.combineLatest(languageCode$, this.currencyCode$).pipe(operators.map(function (_c) {
                ...
                var NaNString = (_b = (_a = parts.find(function (p) { return p.type === 'nan'; })) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 'NaN';
    ...
    var LocaleCurrencyNamePipe = /** @class */ (function (_super) {
        ...
        LocaleCurrencyNamePipe.prototype.transform = function (value, display, locale) {
            ...
            if (display === 'full' || display === 'symbol') {
                var parts = new Intl.NumberFormat(activeLocale, {
                    style: 'currency',
                    currency: value,
                    currencyDisplay: 'symbol',
                }).formatToParts();
    ...
    var LocaleLanguageNamePipe = /** @class */ (function (_super) {
        ...
        function LocaleLanguageNamePipe(dataService, changeDetectorRef) {
            return _super.call(this, dataService, changeDetectorRef) || this;
        }
    ...
    LocaleLanguageNamePipe.ctorParameters = function () { return [
        { type: DataService, decorators: [{ type: i0.Optional }] },
        { type: i0.ChangeDetectorRef, decorators: [{ type: i0.Optional }] }
    ]; };
        ...
        BaseDetailComponent.prototype.init = function () {
            ...
            this.languageCode$ = this.route.paramMap.pipe(operators.map(function (paramMap) { return paramMap.get('lang'); }), operators.switchMap(function (lang) {
                if (lang) {
                    ...
                    return _this.dataService.client.uiState().mapSingle(function (data) { return data.uiState.contentLanguage; });
                }
    ...
    exports.TEXT_CUSTOM_FIELD_FRAGMENT = TEXT_CUSTOM_FIELD_FRAGMENT;
    ...
    exports.TextareaFormInputComponent = TextareaFormInputComponent;
