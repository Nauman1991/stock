...
export declare class OrderTableComponent implements OnInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<OrderTableComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<OrderTableComponent, "vdr-order-table", never, { "order": "order"; "orderLineCustomFields": "orderLineCustomFields"; }, {}, never, never>;
}

//# sourceMappingURL=order-table.component.d.ts.map