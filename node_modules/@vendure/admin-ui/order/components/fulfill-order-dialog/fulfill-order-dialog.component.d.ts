...
export declare class FulfillOrderDialogComponent implements Dialog<FulfillOrderInput>, OnInit {
    ...
    select(): void;
    cancel(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<FulfillOrderDialogComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<FulfillOrderDialogComponent, "vdr-fulfill-order-dialog", never, {}, {}, never, never>;
}

//# sourceMappingURL=fulfill-order-dialog.component.d.ts.map