...
export declare class AddManualPaymentDialogComponent implements OnInit, Dialog<Omit<ManualPaymentInput, 'orderId'>> {
    ...
    submit(): void;
    cancel(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<AddManualPaymentDialogComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<AddManualPaymentDialogComponent, "vdr-add-manual-payment-dialog", never, {}, {}, never, never>;
}

//# sourceMappingURL=add-manual-payment-dialog.component.d.ts.map