...
export declare class OrderListComponent extends BaseListComponent<GetOrderList.Query, GetOrderList.Items> implements OnInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<OrderListComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<OrderListComponent, "vdr-order-list", never, {}, {}, never, never>;
}
export {};

//# sourceMappingURL=order-list.component.d.ts.map