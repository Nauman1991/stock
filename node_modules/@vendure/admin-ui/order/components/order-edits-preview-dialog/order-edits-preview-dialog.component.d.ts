...
export declare class OrderEditsPreviewDialogComponent implements OnInit, Dialog<OrderEditResult> {
    ...
    cancel(): void;
    submit(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<OrderEditsPreviewDialogComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<OrderEditsPreviewDialogComponent, "vdr-order-edits-preview-dialog", never, {}, {}, never, never>;
}
export {};

//# sourceMappingURL=order-edits-preview-dialog.component.d.ts.map