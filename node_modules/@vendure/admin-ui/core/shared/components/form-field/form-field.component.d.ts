...
export declare class FormFieldComponent implements OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<FormFieldComponent, "vdr-form-field", never, { "errors": "errors"; "readOnlyToggle": "readOnlyToggle"; "label": "label"; "for": "for"; "tooltip": "tooltip"; }, {}, ["formFieldControl"], ["*"]>;
}
