...
export declare class ModalDialogComponent<T extends Dialog<any>> {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ModalDialogComponent<any>, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ModalDialogComponent<any>, "vdr-modal-dialog", never, {}, {}, never, never>;
}
