...
export declare class AddressFormComponent {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<AddressFormComponent, "vdr-address-form", never, { "customFields": "customFields"; "formGroup": "formGroup"; "availableCountries": "availableCountries"; }, {}, never, never>;
}
