...
export declare class DatetimePickerComponent implements ControlValueAccessor, AfterViewInit, OnInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<DatetimePickerComponent, "vdr-datetime-picker", never, { "weekStartDay": "weekStartDay"; "timeGranularityInterval": "timeGranularityInterval"; "min": "min"; "max": "max"; "readonly": "readonly"; "yearRange": "yearRange"; }, {}, never, never>;
}
