...
export declare class ChannelAssignmentControlComponent implements OnInit, ControlValueAccessor {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ChannelAssignmentControlComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ChannelAssignmentControlComponent, "vdr-channel-assignment-control", never, { "multiple": "multiple"; "includeDefaultChannel": "includeDefaultChannel"; "disableChannelIds": "disableChannelIds"; }, {}, never, never>;
}

//# sourceMappingURL=channel-assignment-control.component.d.ts.map