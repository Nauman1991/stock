...
export declare class AssetPreviewDialogComponent implements Dialog<void>, OnInit {
    ...
    ngOnInit(): void;
    private hasTags;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<AssetPreviewDialogComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<AssetPreviewDialogComponent, "vdr-asset-preview-dialog", never, {}, {}, never, never>;
}
export {};

//# sourceMappingURL=asset-preview-dialog.component.d.ts.map