...
export declare class FormItemComponent {
    label: string;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<FormItemComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<FormItemComponent, "vdr-form-item", never, { "label": "label"; }, {}, never, ["*"]>;
}
