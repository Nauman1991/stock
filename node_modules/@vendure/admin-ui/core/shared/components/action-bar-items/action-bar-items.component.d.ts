...
export declare class ActionBarItemsComponent implements OnInit, OnChanges {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ActionBarItemsComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ActionBarItemsComponent, "vdr-action-bar-items", never, { "locationId": "locationId"; }, {}, never, never>;
}

//# sourceMappingURL=action-bar-items.component.d.ts.map