...
export declare class CanDeactivateDetailGuard implements CanDeactivate<DeactivateAware> {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<CanDeactivateDetailGuard, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDef<CanDeactivateDetailGuard>;
}

//# sourceMappingURL=can-deactivate-detail-guard.d.ts.map