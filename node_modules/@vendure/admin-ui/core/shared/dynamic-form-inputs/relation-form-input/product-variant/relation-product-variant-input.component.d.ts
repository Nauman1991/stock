...
export declare class RelationProductVariantInputComponent implements OnInit {
    ...
    remove(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<RelationProductVariantInputComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<RelationProductVariantInputComponent, "vdr-relation-product-variant-input", never, { "readonly": "readonly"; "parentFormControl": "parentFormControl"; "config": "config"; }, {}, never, never>;
}

//# sourceMappingURL=relation-product-variant-input.component.d.ts.map