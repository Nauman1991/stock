...
export declare class RelationProductInputComponent implements OnInit {
    ...
    selectProduct(): void;
    remove(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<RelationProductInputComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<RelationProductInputComponent, "vdr-relation-product-input", never, { "readonly": "readonly"; "parentFormControl": "parentFormControl"; "config": "config"; }, {}, never, never>;
}

//# sourceMappingURL=relation-product-input.component.d.ts.map