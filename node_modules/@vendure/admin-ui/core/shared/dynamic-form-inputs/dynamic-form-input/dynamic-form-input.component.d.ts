...
export declare class DynamicFormInputComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy, ControlValueAccessor {
    ...
    private hasUiConfig;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<DynamicFormInputComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<DynamicFormInputComponent, "vdr-dynamic-form-input", never, { "def": "def"; "readonly": "readonly"; "control": "control"; }, {}, never, never>;
}
export {};
