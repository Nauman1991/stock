...
export declare class AddCustomerToGroupDialogComponent implements Dialog<string[]>, OnInit {
    ...
    cancel(): void;
    add(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<AddCustomerToGroupDialogComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<AddCustomerToGroupDialogComponent, "vdr-add-customer-to-group-dialog", never, {}, {}, never, never>;
}

//# sourceMappingURL=add-customer-to-group-dialog.component.d.ts.map