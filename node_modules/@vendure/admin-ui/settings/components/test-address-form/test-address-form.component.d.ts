...
export declare class TestAddressFormComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<TestAddressFormComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<TestAddressFormComponent, "vdr-test-address-form", never, {}, { "addressChange": "addressChange"; }, never, never>;
}

//# sourceMappingURL=test-address-form.component.d.ts.map