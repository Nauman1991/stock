...
export declare class DashboardWidgetComponent implements AfterViewInit, OnDestroy {
    ...
    private loadWidget;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<DashboardWidgetComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<DashboardWidgetComponent, "vdr-dashboard-widget", never, { "widgetConfig": "widgetConfig"; }, {}, never, ["*"]>;
}

//# sourceMappingURL=dashboard-widget.component.d.ts.map