...
function JobListComponent_ng_template_40_vdr_dropdown_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵelement(6, "vdr-object-tree", 17);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function JobListComponent_ng_template_40_vdr_dropdown_15_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "vdr-dropdown");
    ɵngcc0.ɵɵelementStart(1, "button", 18);
    ɵngcc0.ɵɵelement(2, "clr-icon", 15);
    ɵngcc0.ɵɵtext(3);
    ɵngcc0.ɵɵpipe(4, "translate");
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(5, "vdr-dropdown-menu");
    ɵngcc0.ɵɵelementStart(6, "div", 16);
    ɵngcc0.ɵɵelement(7, "vdr-object-tree", 17);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function JobListComponent_ng_template_40_vdr_dropdown_16_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "vdr-dropdown");
    ɵngcc0.ɵɵelementStart(1, "button", 18);
    ɵngcc0.ɵɵelement(2, "clr-icon", 19);
    ɵngcc0.ɵɵtext(3);
    ɵngcc0.ɵɵpipe(4, "translate");
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(5, "vdr-dropdown-menu");
...
function JobListComponent_ng_template_40_vdr_dropdown_18_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function JobListComponent_ng_template_40_vdr_dropdown_18_Template_button_click_4_listener() { ɵngcc0.ɵɵrestoreView(_r17); const job_r7 = ɵngcc0.ɵɵnextContext().item; const ctx_r15 = ɵngcc0.ɵɵnextContext(); return ctx_r15.cancelJob(job_r7.id); });
    ɵngcc0.ɵɵpipe(5, "hasPermission");
    ɵngcc0.ɵɵelement(6, "clr-icon", 24);
    ɵngcc0.ɵɵtext(7);
...
function JobListComponent_ng_template_40_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵtext(12);
    ɵngcc0.ɵɵpipe(13, "duration");
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(14, "td", 9);
    ɵngcc0.ɵɵtemplate(15, JobListComponent_ng_template_40_vdr_dropdown_15_Template, 8, 4, "vdr-dropdown", 11);
    ɵngcc0.ɵɵtemplate(16, JobListComponent_ng_template_40_vdr_dropdown_16_Template, 8, 4, "vdr-dropdown", 11);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(17, "td", 13);
    ɵngcc0.ɵɵtemplate(18, JobListComponent_ng_template_40_vdr_dropdown_18_Template, 9, 7, "vdr-dropdown", 11);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ɵngcc0.ɵɵpipeBind1(8, 10, job_r7.createdAt));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("job", job_r7);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ɵngcc0.ɵɵpipeBind1(13, 12, job_r7.duration));
    ɵngcc0.ɵɵadvance(3);
...
HealthCheckComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: HealthCheckComponent, selectors: [["vdr-health-check"]], decls: 25, vars: 18, consts: [["class", "system-status-header", 4, "ngIf"], ["locationId", "system-status"], [1, "btn", "btn-secondary", 3, "click"], ["shape", "refresh"], [1, "table"], [1, "left"], [4, "ngFor", "ngForOf"], [1, "system-status-header"], [1, "status-icon"], ["size", "48", 3, "ngClass"], [1, "status-detail"], [4, "ngIf", "ngIfElse"], ["error", ""], [1, "last-checked"], [1, "align-middle", "left"], [3, "colorType"], ["down", ""], ["shape", "check-circle"], ["shape", "exclamation-circle"]], template: function HealthCheckComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.ActionBarComponent, ɵngcc1.ActionBarLeftComponent, ɵngcc2.NgIf, ɵngcc1.ActionBarRightComponent, ɵngcc1.ActionBarItemsComponent, ɵngcc3.ClrIconCustomTag, ɵngcc2.NgForOf, ɵngcc2.NgClass, ɵngcc1.ChipComponent], pipes: [ɵngcc2.AsyncPipe, ɵngcc4.TranslatePipe, ɵngcc1.LocaleDatePipe], styles: [".system-status-header[_ngcontent-%COMP%]{display:flex;justify-content:space-between;align-items:flex-start}.system-status-header[_ngcontent-%COMP%]   .status-detail[_ngcontent-%COMP%]{font-weight:700}.system-status-header[_ngcontent-%COMP%]   .last-checked[_ngcontent-%COMP%]{font-weight:400;color:var(--color-grey-500)}"], changeDetection: 0 });
...
JobListComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: JobListComponent, selectors: [["vdr-job-list"]], features: [ɵngcc0.ɵɵInheritDefinitionFeature], decls: 41, vars: 45, consts: [["type", "checkbox", "clrCheckbox", "", "name", "live-update", 3, "formControl"], ["type", "checkbox", "clrCheckbox", "", "name", "hide-settled", 3, "formControl", "change"], ["bindValue", "name", 3, "addTag", "items", "hideSelected", "multiple", "markFirst", "clearable", "searchable", "formControl", "change"], ["ng-label-tmp", "", "ng-option-tmp", ""], ["locationId", "job-list"], [3, "items", "itemsPerPage", "totalItems", "currentPage", "pageChange", "itemsPerPageChange"], [4, "ngIf", "ngIfElse"], ["others", ""], [3, "colorFrom"], [1, "left", "align-middle"], [3, "entity"], [4, "ngIf"], [3, "job"], [1, "right", "align-middle"], ["vdrDropdownTrigger", "", 1, "btn", "btn-link", "btn-icon", 3, "title"], ["shape", "details"], [1, "result-detail"], [3, "value"], ["vdrDropdownTrigger", "", 1, "btn", "btn-link", "btn-sm", "details-button"], ["shape", "exclamation-circle"], ["vdrDropdownTrigger", "", 1, "icon-button"], ["shape", "ellipsis-vertical"], ["vdrPosition", "bottom-right"], ["type", "button", "vdrDropdownItem", "", 1, "delete-button", 3, "disabled", "click"], ["shape", "ban", 1, "is-danger"]], template: function JobListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵtemplate(40, JobListComponent_ng_template_40_Template, 19, 14, "ng-template");
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
        ɵngcc0.ɵɵadvance(4);
...
JobStateLabelComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: JobStateLabelComponent, selectors: [["vdr-job-state-label"]], inputs: { job: "job" }, decls: 5, vars: 6, consts: [[3, "colorType"], ["class", "progress", 4, "ngIf"], [1, "progress"]], template: function JobStateLabelComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "vdr-chip", 0);
        ɵngcc0.ɵɵelement(1, "clr-icon");
        ɵngcc0.ɵɵtext(2);
        ɵngcc0.ɵɵpipe(3, "titlecase");
        ɵngcc0.ɵɵtemplate(4, JobStateLabelComponent_span_4_Template, 3, 3, "span", 1);
        ɵngcc0.ɵɵelementEnd();
    } if (rf & 2) {
...
SystemModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: SystemModule });
SystemModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[SharedModule, RouterModule.forChild(systemRoutes)]] });
