...
class DatalistIdService {
    constructor() {
        this._id = 'clr-datalist-' + ++counter$2;
        this._idChange = new BehaviorSubject(this._id);
    }
    get id() {
        return this._id;
